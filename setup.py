...
setup(
  ...
  download_url='https://github.com/frederikme/TinderBot/archive/1.1.tar.gz',    # I explain this later on
  keywords=['Tinder', 'Automation', 'bot'],   # Keywords that define your project best
  install_requires=['selenium', 'webdriver-manager', 'pyfiglet', 'pillow', 'pyglet', 'scipy'],            # I get to this in a second
